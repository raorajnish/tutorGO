    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-border bg-card overflow-hidden">
        ...
        <div className="divide-y divide-border sm:hidden">
          ...
          {categories?.map((c) => (
            <div key={c.id} className="flex items-center justify-between p-3.5 gap-2">
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                ...
                <ActionMenu
                  items={[
                    ...
                    c.isActive
                      ? { label: "Deactivate", onClick: () => setDeactivating(c), tone: "danger", disabled: busyId === c.id }
                      : { label: "Activate", onClick: () => toggleActive(c), disabled: busyId === c.id },
                  ]}
                />
              </div>
            </div>
