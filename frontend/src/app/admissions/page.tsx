    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          ...
          <h1 className="font-display mt-0.5 text-2xl font-bold text-foreground sm:text-3xl truncate">Admissions</h1>
        </div>
      ...
      <p className="text-sm text-muted-foreground hidden sm:block -mt-3">Admit directly, or convert an open enquiry into a student.</p>
        ...
        {tab === "selfFill" ? (
          ...
          <>
            ...
            <div className="divide-y divide-border sm:hidden">
              ...
              {!loading && paginatedPipeline.map((e) => (
                <div key={e.id} className="space-y-2.5 p-4 transition-colors hover:bg-muted/30">
                  ...
                  <div className="flex items-center justify-between gap-3 pt-0.5">
                    ...
                    <Button variant="secondary" onClick={() => openAdmitFrom(e)} className="shrink-0 px-3.5 py-1.5 text-xs">
                      Admit
                    </Button>
                  </div>
                </div>
          ...
          <>
            ...
            <div className="divide-y divide-border sm:hidden">
              ...
              {!loading && paginatedAdmitted.map((s) => (
                <div key={s.id} className="space-y-2.5 p-4 transition-colors hover:bg-muted/30">
                  <div className="flex items-start justify-between gap-2">
                    <div>
